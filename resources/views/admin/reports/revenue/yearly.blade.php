<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-serif font-bold text-2xl text-bark-600 leading-tight">Yearly Revenue Report - {{ $year }}</h2>
    ...
    <div class="py-8">
        ...
        <div class="mb-8">
            <form method="GET" class="flex gap-4 items-end">
                <div>
                    ...
                    <select name="year" class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="px-6 py-4 bg-gradient-to-r from-purple-500 to-purple-600 border-b">
                <h2 class="text-lg font-bold text-white">Products Sold This Year</h2>
            </div>
