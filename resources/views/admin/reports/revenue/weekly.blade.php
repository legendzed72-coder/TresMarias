<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-serif font-bold text-2xl text-bark-600 leading-tight">Weekly Revenue Report - {{ $startDate->format('M j') }} to {{ $endDate->format('M j, Y') }}</h2>
    ...
    <div class="py-8">
        ...
        <div class="mb-8">
            <form method="GET" class="flex gap-4 items-end">
                <div>
                    ...
                    <input type="date" name="date" value="{{ $startDate->toDateString() }}" class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                </div>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="px-6 py-4 bg-gradient-to-r from-green-500 to-green-600 border-b">
                <h2 class="text-lg font-bold text-white">Products Sold This Week</h2>
            </div>
